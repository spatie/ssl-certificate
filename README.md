# A class to easily query the properties of an SslCertificate
...
**Note:** Replace ```Freek Van der Herten``` ```freekmurze``` ```https://spatie.be``` ```freek@spatie.be``` ```ssl-certificate``` ```A class to easily query the properties of an ssl certificate ``` with their correct values in [README.md](README.md), [CHANGELOG.md](CHANGELOG.md), [CONTRIBUTING.md](CONTRIBUTING.md), [LICENSE.md](LICENSE.md) and [composer.json](composer.json) files, then delete this line.
